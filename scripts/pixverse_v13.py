...
async def main():
    async with async_playwright() as p:
        ...
        # 截图
        await page.screenshot(path="/home/kevin/v13_s1.png")
        ...
        await asyncio.sleep(8)  # 等待跳转到Google

        await page.screenshot(path="/home/kevin/v13_s2.png")
        ...
        if "accounts.google" in page.url:
            ...
            await page.screenshot(path="/home/kevin/v13_s3.png")
